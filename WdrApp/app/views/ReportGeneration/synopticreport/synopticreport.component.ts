...
@Component({
  selector: 'app-synopticreport',
  templateUrl: './synopticreport.component.html',
  styleUrls: ['./synopticreport.component.scss']
})
export class SynopticreportComponent implements OnInit {
