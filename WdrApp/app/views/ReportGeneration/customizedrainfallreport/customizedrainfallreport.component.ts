...
@Component({
  selector: 'app-customizedrainfallreport',
  templateUrl: './customizedrainfallreport.component.html',
  styleUrls: ['./customizedrainfallreport.component.scss']
})
export class CustomizedRainfallReportComponent implements OnInit {
