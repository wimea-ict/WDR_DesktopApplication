...
@Component({
  selector: 'app-weathersummaryreport',
  templateUrl: './weathersummaryreport.component.html',
  styleUrls: ['./weathersummaryreport.component.scss']
})
export class WeatherSummaryReportComponent implements OnInit {
