...
@Component({
  selector: 'app-annualrainfallreport',
  templateUrl: './annualrainfallreport.component.html',
  styleUrls: ['./annualrainfallreport.component.scss']
})
export class AnnualRainfallReportComponent implements OnInit {
